...
import com.ydcqy.ymq.pool.kafka.KafkaPoolConfig;
import com.ydcqy.ymq.pool.kafka.KafkaProducerPool;
...
//        props.put(ProducerConfig.CLIENT_ID_CONFIG, "KafkaProducer");
    ...
    protected void doSend(Queue queue, Message msg) throws MqException {
        ...
        try {
            ...
            producer.send(new ProducerRecord(kafkaQueue.getQueueName(), msg.getEncodeContent()));
        } catch (Exception e) {
